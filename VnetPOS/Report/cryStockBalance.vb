...
Public Class cryStockBalance
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VnetPOS.cryStockBalance.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryStockBalance
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryStockBalance = New cryStockBalance()
        rpt.Site = Me.Site
        Return rpt
    End Function
