...
Public Class cryReOrderStock
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "VnetPOS.cryReOrderStock.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcryReOrderStock
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cryReOrderStock = New cryReOrderStock()
        rpt.Site = Me.Site
        Return rpt
    End Function
