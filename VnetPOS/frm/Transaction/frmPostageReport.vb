Public Class frmPostageReport
    ...
    Private Sub CTRL_Enter(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Enter, txtBillAmountFrom.Enter, txtBillAmountTo.Enter, txtCustomerName.Enter, txtICNo.Enter, cmbOrderNo.Enter
    ...
    End Sub
    Private Sub CTRL_Leave(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtCode.Leave, txtBillAmountFrom.Leave, txtBillAmountTo.Leave, txtCustomerName.Leave, txtICNo.Leave, cmbOrderNo.Leave
    ...
    Private Sub btnSearch_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSearch.Click
        ...
        WQry = "OrderDate between  #" + SDate + "# And #" + EDate + "# and TotAmt>=" + BillAmtFrom.ToString() + " and TotAmt<=" + BillAmtTo.ToString()
        ...
        Dim DTPostage As New DataTable()
        Dim DTPostageDetails As New DataTable()
        DTCompanyDetails = db.CompanyDetails.Grid("*", "CompanyName='" + CompName + "'").ToTable("CompanyDetails")

        DTPostage = db.ViewPostage.Grid("*", WQry).ToTable("ViewPostage")
        WQry = "PostageCode in (select PostageCode from ViewPostage where " + WQry + ")"
        DTPostageDetails = db.ViewPostageDetails.Grid("*", WQry, "PostageCode").ToTable("ViewPostageDetails")

        ds.Clear()
        ds.Tables.Add(DTCompanyDetails)
        ds.Tables.Add(DTPostage)
        ds.Tables.Add(DTPostageDetails)
        ReportView(CrystalReportViewer1, "InventoryReport\cryPostage.rpt", ds)
    ...
    Public Sub viewprint(ByVal Code As String)
        ...
        DTCompanyDetails = db.CompanyDetails.Grid("*", "CompanyName='" + CompName + "'").ToTable("CompanyDetails")
        DTPostage = db.Postage.Grid("*", "PostageCode='" + Code + "'").ToTable("Postage")
        DTPostageDetails = db.PostageDetails.Grid("*", "PostageCode='" + Code + "'").ToTable("PostageDetails")
