Public Class frmSalessearch
    ...
    Sub ViewSearch()
        ...
        WQry = "SalesDate between  #" + SDate + "# And #" + EDate + "#"
        ...
        dgvSearch.Columns("SalesCode").Width = 100
        dgvSearch.Columns("SalesDate").Width = 80
        dgvSearch.Columns("SalesType").Width = 80
        dgvSearch.Columns("MemberName").Width = 200
        ...
        dgvSearch.Columns("SalesDate").DefaultCellStyle.Format = "dd/MM/yyyy"
    ...
    Private Sub dgvSearch_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles dgvSearch.DoubleClick
        Try
            ...
            frmSales.txtSearchBox.Text = txtCode.Text
            frmSales.ViewForm()
            Me.Close()
