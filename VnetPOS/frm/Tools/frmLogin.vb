Public Class frmLogin
    ...
    Private Sub frmLogin_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        ElseIf e.KeyCode = Keys.Scroll And e.Control And e.Shift And e.Alt Then
            Try
                If cmbCompanyName.Text.Trim() = "" Then cmbCompanyName.Text = db.CompanyDetails.Data("CompanyName", "CompanyId=1")
        ...
        Try
            If formvalidation() Then
                ...
                If Type <> "" Then
                    ...
                    'JISDbTransaction = New JISDatabase("Data Source=" + DBServerName + ";Initial Catalog=" + DBName + ";User ID=" + DBUserName + ";Password=" + DBPassword, "SQL")
                    'JISDbTransaction = New JISDatabase("Data Source=.\SQLEXPRESS;AttachDbFilename=F:\DenariuAccountSoft\DenariuAccountSoft\DenariuAccountSoft\bin\Debug\DB\DBMSTPOS_Master_Data.MDF;Integrated Security=True;User Instance=True", "SQL")
                    db = New DBLib()
                    frmMaster.Show()
                    Me.Hide()
