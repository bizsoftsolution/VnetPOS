        ...
        Try
            ...
            For i As Integer = 0 To dv.Count - 1
                If TBs.Contains(dv.Item(i)("Table_Name")) Then
                    TBs(dv.Item(i)("Table_Name")).FieldName.Add(dv.Item(i)("column_name"), New JISField(dv.Item(i)("column_name"), dv.Item(i)("ordinal_position")))
                End If

                If VWs.Contains(dv.Item(i)("Table_Name")) Then
                    VWs(dv.Item(i)("Table_Name")).FieldName.Add(dv.Item(i)("column_name"), New JISField(dv.Item(i)("column_name"), dv.Item(i)("ordinal_position")))
                End If
            Next
...
Public Class JISField
    ...
    Sub New(ByVal FName As String, ByVal FPos As String)
        FieldName = FName
        FieldPosition = FPos
    End Sub
